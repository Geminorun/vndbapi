...
//
//        // HTTP查询数据
//        VndbFilter vndbFilter = new VndbFilter(FilterName.ID.getFilterName(), FilterOperator.EQ.getOperator(), Convert.toStr(vnid));
...
//        // ID
//        archive.setVndbId(Convert.toInt(vn.getId().replace("v", "")));
//        // 标题
...
//            archive.setDeveloper(Convert.toInt(vn.getDevelopers().get(0).getId().replace("p", "")));
//        }
//
//        // 发售日期
