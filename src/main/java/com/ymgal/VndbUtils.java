...
/// <summary>
	...
	{
		protected static String ClientName = "VndbSharp";
		protected static String ClientVersion  = "0.2";
		...
		protected static IEnumerable<String> ConvertFlagsToString(String method, VndbFlags flags)
		{
		...
		protected static async Task<T> GetDumpAsync<T>(String url)
			where T : class
		{
		...
		protected static async Task<IEnumerable<Vote>> GetAndParseVotesAsync(VoteDumpVersion version)
		{
		...
		protected static async Task<String> UnGzip(Stream data, Boolean leaveOpen = false)
		{
